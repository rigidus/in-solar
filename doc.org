...
#+BEGIN_SRC go
  ...
  func ParseFile(fileName string, machineType insolar.MachineType) (*ParsedFile, error) {
      ...
      // TODO: для всех методов, которые имеют хотя бы один Return
      // TODO: - имеют Returnселектор `smachine'
      // TODO: - имеют Call, в котором вызывается селектор, по имени совпадающий со входным параметром, который
      // TODO:   имеет Context-like тип
      // TODO: собрать выходное ребро и сформироват целевой узел
      // TODO: если оно указывает на одно States
