...
Кирилл: у Миши задача, чтобы было можно вставлять в конфлу кусочки от
godoc сославшись на класс и т.п.  (не уверен, что тэги это хорошая идея)
...
BorderContract описать и сетевой вызов другого контракта по этой картинке

https://insolar.atlassian.net/wiki/spaces/DEV/pages/1092517974/Core+v2+-+Compartments+and+APIs

Посмотреть в конфле Delegation Tokens

описать иерарахичный семафор с возможностью частичного отпуска родителя

Ссылаться из конфлы на выгрузку GoDoc
